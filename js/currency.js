! function () {
    ...
    function n() {
        ...
        function l(e, t, a, i, l, s, d, p, m, u, h, g, f, v, x, y, b) {
            var L = "#093";
            m < 0 && (L = "#d14836"), m = n.toLocaleString(m, {
                minDecimalPlaces: 2,
                maxDecimalPlaces: 2
            }), valTickerHTML = f ? "(" + a + ")" : "", valPrice = s ? o(s, i) : "?", valPercentHTML = m ? '<span style="color:' + L + '">(' + m + "%)" : "", valMarketCap = u ? r(u, 2) : "?", valVolume = h ? r(h, 2) : "?", d ? (mainLineHeight = 25, valPriceSecondary = p ? o(p, d) : "?", secondaryHTML = '<br><span style="font-size: 12px; color:gray">' + valPriceSecondary + " " + d + " </span>") : (mainLineHeight = 30, secondaryHTML = "");
            ...
            }(v, x, y, b, l, g, valMarketCap, valVolume), k += '    <div style="border-top: 1px solid #E4E6EB;text-align:center;clear:both;font-size:10px;font-style:italic;padding:5px 0;">        <a href="http://coinmarketcap.com?' + w + '" target="_blank">Powered by CoinMarketCap</a>    </div></div>'
        }
                ...
                e.get({
                    ...
                    success: function (m) {
                        var u = "price_" + a.toLowerCase(),
                            ...
                            L = m[0].name,
                            w = m[0].symbol,
                            k = Number(m[0].percent_change_24h),
                            E = m[0].rank,
                            P = l(t, L, w, a, n, v, i, x, k, y, b, E, r, o, s, c, d);
